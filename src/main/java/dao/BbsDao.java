...
public class BbsDao {
	...
	public boolean answer(int seq, BbsDto dto) {
		...
		// count1은 업뎃이 없을수도 있으므로 count2만 필요
		if(count2 > 0) {
			return true;
		}else {
			return false;
	...
	// boolean 업뎃이 됐는지 안됐는지 알아보기 위해 사용 기본글은 getbbs로 깔아주기
