...
// 페이지 넘버
String sPageNumber = request.getParameter("pageNumber");	// parameter는 무조건 string으로 받는다.
int pageNumber = 0;
if(sPageNumber !=null && !sPageNumber.equals("")){		// sPageNumber가 넘어옴
...
// 페이지 총수
int pageBbs = count / 10;		// 10개씩  총 글의 수를 나눔		26 / 10 -> 2
if((count % 10) > 0){		// 6
...
if(search != ""){
	...
	obj.value = "<%=choice %>";
	obj.setAttribute("selected", "selected");	// 값을 넣어주고 값대로 select해줘라
}
